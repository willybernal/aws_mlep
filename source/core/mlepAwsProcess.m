classdef mlepAwsProcess < handle
    ...
    methods
        ...
        %%==============================================================
        function [status, msg, EC2_info] = initAwsInstance(obj, numInst, instType, amiCode)
            EC2_info = mlepInitAwsInstance(obj.ec2Client, numInst, obj.keyPath, obj.secGroup, instType, amiCode);
